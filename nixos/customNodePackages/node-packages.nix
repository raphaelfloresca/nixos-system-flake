...
in
{
  ...
  excalidraw_export = nodeEnv.buildNodePackage {
    name = "excalidraw_export";
    packageName = "excalidraw_export";
    version = "1.0.1";
    src = fetchurl {
      url = "https://registry.npmjs.org/excalidraw_export/-/excalidraw_export-1.0.1.tgz";
      sha512 = "1XELL6OfSL40Nh6EOkaEqridjU2cuNykgl4rftGvzXIga6KtG6AZQFMWUgzUpmaXNyXrTuvYqn8yaq/dBTCZfQ==";
    };
    dependencies = [
      sources."@mapbox/node-pre-gyp-1.0.11"
    ...
    buildInputs = globalBuildInputs;
    meta = {
      description = "CLI to export Excalidraw drawings";
      homepage = "https://github.com/Timmmm/excalidraw_export#readme";
      license = "MIT";
    };
    production = true;
    bypassCache = true;
